...
def export_results_bc12fc2b(folder, input1, input2, output1, output2, output3, output4, output5, output6, output7, output8, output9, output10):
    return _execute("export-results", "export_results_bc12fc2b", "Export clean data and report", folder, [input1, input2], {"data_parquet": output1, "data_csv": output2, "summary_json": output3, "visualization_json": output4, "visualization_png": output5, "provenance_json": output6, "processing_report": output7, "map_geojson": output8, "data_netcdf": output9, "result_bundle": output10})
