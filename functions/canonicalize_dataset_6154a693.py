...
def canonicalize_dataset_6154a693(folder, input1, input2, output1, output2, output3, output4, output5, output6, output7, output8):
    return _execute("canonicalize-dataset", "canonicalize_dataset_6154a693", "Finalize canonical dataset", folder, [input1, input2], {"data_parquet": output1, "data_csv": output2, "summary_json": output3, "visualization_json": output4, "visualization_png": output5, "provenance_json": output6, "processing_report": output7, "map_geojson": output8})
